// ======================================
// LearnInCreation Website Search
// ======================================
...
const pages = [

    {
        ...
        url: "msword-fundamental-1.html",
        description: "Learn Microsoft Word fundamentals and basic document creation skills.",
        keywords: "Microsoft Word MS Word Word fundamentals Word course beginners"
    },

    {
        title: "How to Open Microsoft Word",
        url: "start-ms-word.html",
        description: "Learn how to open and start Microsoft Word step by step.",
        keywords: "open Microsoft Word start MS Word Word beginners"
    },

    {
        title: "Why Learn Microsoft Word?",
        url: "why-to-learn.html",
        description: "Discover the benefits and important features of Microsoft Word.",
        keywords: "why learn Microsoft Word Word benefits MS Word features"
    },

    {
        title: "How to Create a Word Document",
        url: "create-ms-word-document.html",
        description: "Learn how to create a new Microsoft Word document using a blank document or template.",
        keywords: "create Word document new document Microsoft Word MS Word"
    },

    {
        title: "Microsoft Word Keyboard Shortcuts",
        url: "keyboard-shortcut.html",
        description: "Learn useful Microsoft Word keyboard shortcuts and how to customize shortcut keys.",
        keywords: "Word keyboard shortcuts MS Word shortcut keys Microsoft Word shortcuts"
    },

    {
        title: "Microsoft Word Interface",
        url: "knowing-your-word-screen.html",
        description: "Understand the main parts of the Microsoft Word screen and interface.",
        keywords: "Word interface MS Word screen Word window Ribbon Title Bar Status Bar"
    },

    {
        title: "Quick Access Toolbar and Ruler",
        url: "quick-access-toolbar-and-ruler.html",
        description: "Learn about the Quick Access Toolbar and Ruler in Microsoft Word.",
        keywords: "Quick Access Toolbar Word ruler MS Word toolbar Word interface"
    },

    {
        title: "How to Format Text in Microsoft Word",
        url: "formatting-text.html",
        description: "Learn how to format text using fonts, font size, bold, italic, underline and colors.",
        keywords: "format text Word text formatting font bold italic underline MS Word"
    },

    {
        title: "How to Insert and Delete Text",
        url: "inserting-and-removing-text.html",
        description: "Learn how to insert, edit and delete text in Microsoft Word.",
        keywords: "insert text delete text edit Word document Backspace Delete MS Word"
    },

    {
        title: "How to Insert a Picture in Word",
        url: "inserting-picture-in-documents.html",
        description: "Learn how to insert, resize, move and format pictures in Microsoft Word.",
        keywords: "insert picture Word insert image MS Word images resize picture"
    },

    {
        title: "How to Insert Symbols in Word",
        url: "inserting-symbols.html",
        description: "Learn how to insert symbols and special characters in Microsoft Word.",
        keywords: "Word symbols special characters copyright trademark check mark MS Word"
    },

    {
        title: "How to Insert and Format Page Numbers",
        url: "inserting-and-formating-page-number.html",
        description: "Learn how to insert and format page numbers in Microsoft Word.",
        keywords: "Word page numbers insert page number format page numbering MS Word"
    },

    {
        title: "How to Save and Edit a Word Document",
        url: "save-or-edit-document.html",
        description: "Learn how to save, edit and update Microsoft Word documents.",
        keywords: "save Word document edit Word document Save As MS Word"
    },
